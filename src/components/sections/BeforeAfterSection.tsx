      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {cases.map((c) => (
            <div
              key={c.procedure}
              className="group overflow-hidden rounded-2xl border border-cream-dark card-hover"
            >
              {/* Image comparison */}
              <div className="relative grid grid-cols-2 h-64 overflow-hidden">
                {/* Before */}
                <div
                  className={`relative bg-gradient-to-br ${c.beforeBg} flex items-end justify-start p-3`}
                >
                ...
                {/* After */}
                <div
                  className={`relative bg-gradient-to-br ${c.afterBg} flex items-end justify-end p-3`}
                >
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <span className="bg-navy/30 backdrop-blur-sm text-white/50 text-[9px] tracking-widest uppercase px-2 py-0.5 rounded">
                    Photo placeholder
                  </span>
                </div>
              </div>
        ...
        <div className="text-center">
          <p className="text-navy/40 text-xs mb-6 italic">
            * Actual patient photos are available during your private
            consultation and in the full gallery.
          </p>
          <Link
            href="/gallery"
