...
export default function DoctorSection() {
  return (
    ...
    >
      {/* ── Doctor photo — left half background ── */}
      <div className="absolute inset-0 lg:w-[50%]">
        <Image
          src="/doctor-bg.png"
          ...
          quality={90}
        />
        {/* Gradient fade right so it blends into content panel */}
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-navy-dark/40 to-navy-dark" />
        {/* Bottom fade */}
        <div className="absolute inset-0 bg-gradient-to-t from-navy-dark/60 via-transparent to-navy-dark/30" />
      </div>

      {/* ── Content panel — right side ── */}
      <div className="relative z-10 w-full px-6 lg:px-16 py-14 flex justify-end">
        <div className="w-full lg:w-[58%] xl:w-[55%] pr-8 xl:pr-16">
          ...
          {/* Heading — SEO h2 with doctor name */}
          ...
          <p className="text-white/70 text-base leading-relaxed mb-8 font-sans max-w-xl">
